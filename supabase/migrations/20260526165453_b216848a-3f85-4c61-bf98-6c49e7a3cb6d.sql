...
-- ============= GRANTS =============
GRANT SELECT, INSERT, UPDATE, DELETE ON public.profiles, public.leads, public.mensagens, public.tags, public.lead_tags, public.notas, public.anexos, public.eventos_feed, public.configuracoes_ia, public.configuracoes_captacao, public.blacklist, public.relatorios TO authenticated;
GRANT ALL ON public.profiles, public.leads, public.mensagens, public.tags, public.lead_tags, public.notas, public.anexos, public.eventos_feed, public.configuracoes_ia, public.configuracoes_captacao, public.blacklist, public.relatorios TO service_role;
...
CREATE POLICY "notas_insert" ON public.notas FOR INSERT TO authenticated WITH CHECK (autor_id = auth.uid());
...
CREATE POLICY "eventos_write" ON public.eventos_feed FOR INSERT TO authenticated
  WITH CHECK (public.get_user_role() IN ('gestor','admin'));
